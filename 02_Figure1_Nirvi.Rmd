...
Replication of figures and tables from the paper
...
rsquare(household_model, household_data)
```
...
rsquare(insure_model, insure_data)
```
...
rsquare(white_model, white_data)
```
...
rsquare(income_model, income_data)
```
...
rsquare(elder_model, elder_data)
```